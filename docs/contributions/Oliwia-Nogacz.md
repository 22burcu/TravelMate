...
| 2 | Bewertungssystem (apply.html); neue Blueprint-Route registriert in __init__.py; apply.html also Bewerbungsformular mit Nachricht + Budget erstellt | Kleinen bug geffixt der sehr leicht zu übersehen war, __ name __ statt _ name _, in einer Stresssituation kurz vor der Abgabe | Herausforderungen: Blueprint registrieren und debuggen |
